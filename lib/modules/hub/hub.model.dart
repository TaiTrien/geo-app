...
List<Hub> hubFromJson(String str) => List<Hub>.from(json.decode(str).map((x) => Hub.fromJson(x)));

String hubToJson(List<Hub> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
